...
<?php 
	echo get_evenement_res_code('crawl_res_code', 0);
	echo get_evenement_res_code('visites_res_code', 1);
	echo get_last_res_code('last_res_code');
?>
	...
	<body>
		...
		<div id="crawl_res_code" style="min-width: 400px; height: 400px; margin: 0 auto"></div>
		<div id="visites_res_code" style="min-width: 400px; height: 400px; margin: 0 auto"></div>
		<div id="last_res_code" style="min-width: 400px; height: 400px; margin: 0 auto"></div>
