...
<?php 
	echo get_visites_quotidien('visites_quotidien'); 
	echo get_visites_30j('visites_30j');
	echo get_visites_global_heure('visites_global_heure');
?>
	...
	<body>
		...
		<div id="visites_quotidien" style="min-width: 400px; height: 400px; margin: 0 auto"></div>
		<div id="visites_30j" style="min-width: 400px; height: 400px; margin: 0 auto"></div>
		<div id="visites_global_heure" style="min-width: 400px; height: 400px; margin: 0 auto"></div>
